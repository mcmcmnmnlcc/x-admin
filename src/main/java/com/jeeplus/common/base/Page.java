...
//		sb.append("</div>");
		...
		sb.append("<li class=\""+getSelected(pageSize,300)+ "\"><a href=\"javascript:"+funcName+"("+pageNo+",300,'"+funcParam+"');\">300</a></li>");
		sb.append("<li class=\""+getSelected(pageSize,500)+ "\"><a href=\"javascript:"+funcName+"("+pageNo+",500,'"+funcParam+"');\">500</a></li>");
		sb.append("<li class=\""+getSelected(pageSize,2000)+ "\"><a href=\"javascript:"+funcName+"("+pageNo+",2000,'"+funcParam+"');\">2000</a></li>");
		sb.append("</ul>");
